...
public class HttpFactory
{
	...
	private HttpFactory()
	{
		try
		{
			int pooledHttpConn = Integer.parseInt(ConfigFactory.getInstance().get("pooled.http.conn.num"));
	...
	public HttpClient getHttpClient()
	{
		...
		Integer socketTimeout = Integer.parseInt(ConfigFactory.getInstance().get("socket.timeout"));
		Integer connectionTimeout = Integer.parseInt(ConfigFactory.getInstance().get("connection.timeout"));
		final int retryTime = Integer.parseInt(ConfigFactory.getInstance().get("retry.time"));
