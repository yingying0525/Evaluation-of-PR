...
public class Hbn
{
    ...
    public static <T> T getElementFromDB(Session session,Class obj,int id){
    ...
    public static <T> List<T> getElementsFromDBC(Session session,Class aClass,short start ,short end,int maxNum) {
        List<T> result = new ArrayList<T>();
    ...
    public int getMaxFromDB(Class aClass,String col){
    ...
    public static int getMaxFromDB(Session session,Class aClass,String col){
